...
export function RegisterForm() {
  ...
  return (
    <>
      ...
      >
        {({ isSubmitting }) => (
          <Form className="flex flex-col max-sm:mt-2 items-center justify-center h-full px-4 sm:px-12 bg-white w-full max-w-md mx-auto">
            <h1 className="text-3xl font-bold mb-4">Register</h1>
            <div className="mb-4 max-sm:mb-0 w-full">
              <Field
                type="text"
                name="name"
                placeholder="Name"
            ...
            <a
              href="/login"
              className="sm:hidden flex justify-center w-full sm:w-80 mb-4 bg-[#b2f5f7] hover:bg-[#45a3a4]"
            >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="#"
                className="border rounded-full p-2 hover:border-[#4bb6b7] transition-colors"
              >
                <Facebook size={20} />
              </a>
              <a
